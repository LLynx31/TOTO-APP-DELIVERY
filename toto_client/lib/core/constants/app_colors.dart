...
/// Couleurs de l'application TOTO - Palette "Green Rider"
/// Énergique, fraîche, parfaite pour l'Afrique de l'Ouest
class AppColors {
  AppColors._();

  // Couleurs principales
  static const Color primary = Color(0xFF00C853); // Vert vif (action, mouvement)
  static const Color primaryDark = Color(0xFF00A843);
  static const Color primaryLight = Color(0xFF5EFC82);

  // Couleurs secondaires
  static const Color secondary = Color(0xFF004E89); // Bleu foncé (stabilité, confiance)
  static const Color secondaryDark = Color(0xFF003A66);
  static const Color secondaryLight = Color(0xFF0066A8);

  // Couleurs d'accent
  static const Color accent = Color(0xFFFFD23F); // Jaune doré (optimisme, rapidité)
  ...
  static const Color statusInProgress = Color(0xFFFFD23F); // Jaune doré
  static const Color statusDelivered = Color(0xFF00C853); // Vert vif
  static const Color statusCancelled = Color(0xFFF44336); // Rouge vif
  static const Color statusPending = Color(0xFF938E94); // Gris
