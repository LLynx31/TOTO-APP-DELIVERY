...
import 'quota_recharge_screen.dart';

/// Écran affichant l'historique complet des achats de quotas
class QuotaHistoryScreen extends ConsumerStatefulWidget {
  const QuotaHistoryScreen({super.key});

  @override
  ConsumerState<QuotaHistoryScreen> createState() => _QuotaHistoryScreenState();
}

class _QuotaHistoryScreenState extends ConsumerState<QuotaHistoryScreen> {
  ...
  Future<void> _loadTransactions() async {
    ...
    try {
      ...
      if (transactions.isEmpty) {
        print('⚠️ No transactions found - showing empty state');
      }
    } catch (e) {
